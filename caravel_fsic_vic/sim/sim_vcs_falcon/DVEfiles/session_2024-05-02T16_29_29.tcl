...
# DVE full session
# Saved on Thu May 2 16:29:25 2024
# Designs open: 1
...
# DVE version: T-2022.06
# DVE build date: May 31 2022 21:48:47


#<Session mode="Full" path="/home/raid7_2/userp/b0126168/tony/University_LAB/lab_formal_release/lab_synthesis/sim_vcs_edge/DVEfiles/session.tcl" type="Coverage">
...
gui_show_window -window ${CovTopLevel.1} -show_state normal -rect {{1929 917} {2647 1625}}
...
gui_update_layout -id ${CovHier.1} {{left 0} {top 0} {width 199} {height 398} {dock_state left} {dock_on_new_line true} {child_covhier_colhier 140} {child_covhier_coltype 100} {child_covhier_col1 1} {child_covhier_col2 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 718} {height 179} {dock_state bottom} {dock_on_new_line true}}
...
gui_open_cov  -hier {simv_dff_exp.vdb}   -testdir {simv_dff_exp.vdb} -autoopen False  -test { {simv_dff_exp/simv_dff_exp} } -merge {MergedTest}
...
catch {gui_list_expand -id ${CovHier.1} top_bench}
catch {gui_list_expand -id ${CovHier.1} top_bench}
catch {gui_list_select -id ${CovHier.1} {top_bench.uut}}
gui_covtable_show -id CoverageTable.1 -show {Design Hierarchy}  -cumulative 1
catch {gui_list_expand -id ${CoverageTable.1} top_bench}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut.mprj}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut.mprj.u_fsic}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut.mprj}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut.mprj.u_fsic}
catch {gui_list_expand -id ${CoverageTable.1} top_bench.uut.mprj}
