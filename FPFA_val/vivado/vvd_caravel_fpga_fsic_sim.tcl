...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../virtual_t18_pad.v"]"\
 "[file normalize "$origin_dir/../spram.v"]"\
 "[file normalize "$origin_dir/../caravel_fpga.v"]"\
 "[file normalize "$origin_dir/../caravel.v"]"\
